...
const ExplorePage = () => {
  ...
  const exploreRepos = async (language) => {
    ...
    try {
      const res = await fetch(`https://api.github.com/search/repositories?q=language:${language}&sort=star&order=desc&per_page=10`, {
        headers: {
  ...
  return (
    <div className="p-4">
      <div className="p-3 bg-glass max-w-2xl mx-auto rounded-md">

        <h1 className="text-xl font-bold text-center">Explore Popular Repositories</h1>
        <div className='flex flex-wrap gap-2 my-2 justify-center'>

          <img src='/javascript.svg' alt='JavaScript' className='h-11 sm:h-20 
          cursor-pointer' onClick={() => exploreRepos('javascript') } />
